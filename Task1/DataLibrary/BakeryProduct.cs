...
namespace DataLibrary
{
    ...
    public abstract class BakeryProduct
    {
        ...
        public BakeryProduct(decimal markup, string name, params Ingredient[] ingredients)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public virtual decimal GetPrice() => Ingredients.Sum(a => a.Price) + Markup;
        ...
        public override bool Equals(object obj)
        {
            ...
            Answer &= this.Ingredients.SequenceEqual<Ingredient>(other.Ingredients);
        ...
        public override int GetHashCode()
        {
            ...
            {
                hashCode = hashCode * 1013 + ingredient.GetHashCode();
            }
